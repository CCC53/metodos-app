...
import { NewtonRaphsonRes, NewtonRaphsonSolutionRes } from '../../types/iterations';
...
const setTableData = (data: NewtonRaphsonRes[]) => {
...
export const NewtonRaphsonPage = () => {
  ...
  const initialState: NewtonRaphsonSolutionRes = {
    data: [],
    solution: 0
  };

  const [res, setRes] = useState<NewtonRaphsonSolutionRes>(initialState);
