...
export const GaussjordanComponent: React.FC =():JSX.Element => {
    ...
    return (
        ...
        <div className="container">
                  ...
                  <Input name={"filas"} type="number" step="any" onChange={handleInputChange}/>
                  <br/>
                  <br/>
                  <br/>
                  <Label htmlFor="columnas">{"columnas"}</Label>
                  <Input name={"columnas"} type="number" step="any" onChange={handleInputChange} />
                  <Button name={"columnas"} onClick={() => {
                            ...
                            <div key={index} style={{display:"flex"}}>
                              
                                {
                                    element.map((el:any,indexSubArray:any) => (
                                        ...
                                        <Input style={{width:70}} name={"columnas"} type="number" step="any" defaultValue={el} onChange={(eve) => {
                  ...
                  <Button name={"columnas"} onClick={() =>{
                       alert(matrizGenerated)
                       console.log(matrizGenerated)
                  }} >AAAAAAAAAAA</Button>
